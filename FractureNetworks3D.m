...
Cell_N = 20 ; Cell_M = Cell_N ; Cell_L = Cell_N; 
...
ParametersofFracture(:,3:14) = [0.2,0.2,0.2,  0.6,0.7,0.2,  0.6,0.7,0.9,  0.2,0.2,0.9;...
                                0.1,0.1,0.3,  0.1,0.7,0.7,  0.4,0.7,0.7,  0.4,0.1,0.3;...
                                0.4,0.3,0.2,  0.7,0.3,0.8,  0.7,0.6,0.8,  0.4,0.6,0.2 ]...
...
drawgrids(xmin,xmax,ymin,ymax,zmin,zmax,Cell_N,Cell_M,Cell_L); hold off;
