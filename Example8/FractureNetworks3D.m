...
Cell_N = 33 ; Cell_M = Cell_N ; Cell_L = Cell_N; 
...
ParametersofFracture(:,3:14) = [1/2,1/3,4/5,  1/5,1/3,1/5,   1/5,2/3,1/5,   1/2,2/3,4/5;...
                                1/2,1/3,4/5,   4/5,1/3,1/5,   4/5,2/3,1/5,   1/2,2/3,4/5;...
                                7/20,1/3,1/2,  13/20,1/3,1/2,  13/20,2/3,1/2,  7/20,2/3,1/2 ]...
                              + (rand(NumberofFractures,12)-0.5)*1e-3; % position of fractures
% plot the fractures and grids
figure; hold on;
fill3(ParametersofFracture(:,3:3:14)',ParametersofFracture(:,4:3:14)',ParametersofFracture(:,5:3:14)','r');
%drawgrids(xmin,xmax,ymin,ymax,zmin,zmax,Cell_N,Cell_M,Cell_L); 
...
yslice = [0.5];
zslice = [0.5];
slice(XX,YY,ZZ,VV,xslice,yslice,zslice);
colormap('jet');
shading interp
